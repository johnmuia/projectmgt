...
task_view->project->name: {{ $task_view->project->name }}  <br>
...
<div class="card col-md-8">
    ...
    <div class="btn-group">
        <a href="{{ route('task.edit', ['id' => $task_view->id ]) }}" class="btn btn-primary"> <i class="material-icons">edit</i> </a>
...
<div class="card col-md-4">
    ...
    <div class="panel panel-jc">
        <div class="panel-heading bold-text">Created</div>
        <div class="panel-body">
            {{ $formatted_from }} 
        </div>
    </div>
