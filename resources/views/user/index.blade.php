            ...
            <div class="row">
                <div class="col-md-7">
                    <label>Create new User <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></label>
                        ...
                        <div class="form-group">
                            <input type="password" id="show_hide_password" class="form-control" placeholder="Enter User Password" name="password">
                        </div>
...
@if ( !$users->isEmpty() ) 
    ...
    @endif
      <tr>
        ...
        <td>
            <a href="{{ route('user.edit', ['id' => $user->id]) }}" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span></a>
 
            <a href="{{ route('user.delete', ['id' => $user->id]) }}" class="btn btn-danger" Onclick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true">Delete</span></a>
